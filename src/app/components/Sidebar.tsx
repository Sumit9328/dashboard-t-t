...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { label: "Packages", icon: <Package size={20} />, href: "./componentpages/packages" },
    { label: "Chats", icon: <MessageSquare size={20} />, href: "../componentpages/chats" },
    { label: "Reports", icon: <FileText size={20} />, href: "../componentpages/reports" },
    { label: "Team", icon: <Users size={20} />, href: "/componentpages/team" },
    { label: "Settings", icon: <Settings size={20} />, href: "../componentpages/settings" },
  ];
